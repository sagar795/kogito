 ...
 */
package https_58_47_47kiegroup_46org_47dmn_47__209413C1_45F115_454DE4_4582E7_450B64F33D4E33;
...
@Path("/Ticket-Price")
public class Ticket_45PriceResource {
    ...
    @org.eclipse.microprofile.openapi.annotations.parameters.RequestBody(content = @org.eclipse.microprofile.openapi.annotations.media.Content(mediaType = "application/json", schema = @org.eclipse.microprofile.openapi.annotations.media.Schema(ref = "/dmnDefinitions.json#/definitions/InputSet3")), description = "DMN input")
    @org.eclipse.microprofile.openapi.annotations.responses.APIResponse(content = @org.eclipse.microprofile.openapi.annotations.media.Content(mediaType = "application/json", schema = @org.eclipse.microprofile.openapi.annotations.media.Schema(ref = "/dmnDefinitions.json#/definitions/OutputSet3")), description = "DMN output")
    ...
    public Response dmn(java.util.Map<String, Object> variables) {
        org.kie.kogito.decision.DecisionModel decision = application.get(org.kie.kogito.decision.DecisionModels.class).getDecisionModel("https://kiegroup.org/dmn/_209413C1-F115-4DE4-82E7-0B64F33D4E33", "Ticket-Price");
        ...
        KogitoDMNResult result = new KogitoDMNResult("https://kiegroup.org/dmn/_209413C1-F115-4DE4-82E7-0B64F33D4E33", "Ticket-Price", decisionResult);
    ...
    public String dmn() throws java.io.IOException {
        return new String(org.drools.core.util.IoUtils.readBytesFromInputStream(this.getClass().getResourceAsStream(org.kie.dmn.feel.codegen.feel11.CodegenStringUtil.escapeIdentifier("Ticket-Price") + ".dmn_nologic")));
    }
