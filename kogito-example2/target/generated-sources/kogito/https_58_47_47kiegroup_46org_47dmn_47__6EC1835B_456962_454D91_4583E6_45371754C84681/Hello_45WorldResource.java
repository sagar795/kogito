 ...
 */
package https_58_47_47kiegroup_46org_47dmn_47__6EC1835B_456962_454D91_4583E6_45371754C84681;
...
@Path("/Hello-World")
public class Hello_45WorldResource {
    ...
    public Response dmn(java.util.Map<String, Object> variables) {
        org.kie.kogito.decision.DecisionModel decision = application.get(org.kie.kogito.decision.DecisionModels.class).getDecisionModel("https://kiegroup.org/dmn/_6EC1835B-6962-4D91-83E6-371754C84681", "Hello-World");
        ...
        KogitoDMNResult result = new KogitoDMNResult("https://kiegroup.org/dmn/_6EC1835B-6962-4D91-83E6-371754C84681", "Hello-World", decisionResult);
    ...
    public String dmn() throws java.io.IOException {
        return new String(org.drools.core.util.IoUtils.readBytesFromInputStream(this.getClass().getResourceAsStream(org.kie.dmn.feel.codegen.feel11.CodegenStringUtil.escapeIdentifier("Hello-World") + ".dmn_nologic")));
    }
